...
![Tableau 1: Statistiques des vas utilisées](assets/images/summary_statistics_table.png)
...
![Figure 1: Corrélations des variables utilisées](assets/images/correlation_matrix.png)
...
![Figure 2: Part des isolés de 30 ans et plus dans le total des ménages privés](assets/images/part-des-isoles-de-30-ans-et-plus-dans-le-total-des-menages-prives.png)
...
![Tableau 2: Résultat de la régression linéaire](assets/images/ols_results_table.png)
...
![Tableau 3: Résultat de la GWR](assets/images/ols_synthesis_table.png)

*Tableau 3: Résultat de la GWR*

![Figure 3: R2 local du modèle GWR](assets/images/gwr_local_r2.png)
...
![Figure 4: Coefficients GWR par secteurs statistiques](assets/images/gwr_local_coefficients.png)
